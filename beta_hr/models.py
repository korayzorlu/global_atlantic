...
class TheCompany(models.Model):
    ...
    updated_by = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, related_name="beta_updated_by")
...
class BankAccount(models.Model):
    ...
    the_company = models.ForeignKey(TheCompany, on_delete=models.CASCADE, related_name="beta_bank_accounts")
