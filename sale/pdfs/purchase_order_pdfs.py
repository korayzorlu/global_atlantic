...
def purchaseOrderPdf(id, sourceCompanyId):
    ...
    purchaseOrder = PurchaseOrder.objects.select_related("inquiry__theRequest","inquiry__supplier").filter(id = id).first()
    ...
    parts = purchaseOrder.purchaseorderpart_set.select_related("inquiryPart__requestPart__part").order_by("sequency").all()
    items = []
    for part in parts:
    ...
    p.drawString(35, h-210, "We thank you for your inquiry and are pleased to offer subject to unsold and subject to our")
    p.drawString(35, h-220, "standard sales & purchase conditions ( available on request) for;")
    ...
    table.wrapOn(p, w/2+5, h-220)
    table.drawOn(p, w/2+5, h-220)
    ...
    table.wrapOn(p, (w/2+5)+(((w/2-35)/3)), h-220)
    table.drawOn(p, (w/2+5)+(((w/2-35)/3)), h-220)
    #####sağ üst tablo-end#####
    ...
    for key, theItems in enumerate(allItems):
        ...
        table.wrapOn(p, 30, th-225-sum(table._rowHeights))
        table.drawOn(p, 30, th-225-sum(table._rowHeights))
        ...
        if key == len(allItems) - 1 and extraPage == 0:
            ...
            totalTable.wrapOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4), th-225-sum(table._rowHeights)-39)
            totalTable.drawOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4), th-225-sum(table._rowHeights)-39)
            ...
            totalTable.wrapOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4)+tableTotalLeftLength, th-225-sum(table._rowHeights)-39)
            totalTable.drawOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4)+tableTotalLeftLength, th-225-sum(table._rowHeights)-39)
            tableTotalLeftLength = totalTable._colWidths[0]
            
            #####alttaki note remark yazıları##### 
            p.setFont('Inter-Bold', 7)
            p.drawString(30, th-235-sum(table._rowHeights), "INVOICE TO")
            p.setFont('Inter', 7)
            p.drawString(80, th-235-sum(table._rowHeights), sourceCompanyFormalName)
            p.drawString(80, th-245-sum(table._rowHeights), sourceCompanyAddress)
            p.drawString(80, th-255-sum(table._rowHeights), "TUZLA VD. 3801139954")
            ...
            p.setFont('Inter-Bold', 7)
            p.drawString(30, th-265-sum(table._rowHeights), "NOTES")
            p.setFont('Inter', 7)
            ...
            lines = lines.split('\n')
            line_height = 10  # İsteğe bağlı, satır yüksekliği
            current_y = th-265-sum(table._rowHeights)
        ...
        if key == len(allItems) - 1 and extraPage == 1:
            ...
            totalTable.wrapOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4), th-225-39)
            totalTable.drawOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4), th-225-39)
            tableTotalLeftLength = totalTable._colWidths[0]
            ...
            totalTable.wrapOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4)+tableTotalLeftLength, th-225-39)
            totalTable.drawOn(p, 30+(((w-60)/100)*4)+(((w-60)/100)*15)+(((w-60)/100)*32)+(((w-60)/100)*8)+(((w-60)/100)*9)+(((w-60)/100)*4)+(((w-60)/100)*4)+tableTotalLeftLength, th-225-39)
            tableTotalLeftLength = totalTable._colWidths[0]
