...
function setActiveProjectServiceCardDetailDatatable(){
...
/**/let apiSource = '/service/api/offer_service_cards?offer=' + activeProjectId + '&extra=false&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function setActiveProjectServiceCardExtraDetailDatatable(){
    let es = elementTagSub + "-" + elementTagId + "-serviceCardExtra";
    let id = activeProjectId
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/active_project_service_card_extra_add_in_detail/o_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
...
/**/let deleteDataUrl = "/service/offer_service_card_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_service_cards?offer=' + activeProjectId + '&extra=true&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function setActiveProjectExpenseDetailDatatable(){
...
/**/let addDataHxGet = "/service/active_project_expense_add_in_detail/o_" + id + "/";
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/service/active_project_expense_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_expenses?offer=' + activeProjectId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
        ...
        {"data" : "unitPrice", className:"editable", render: function (data, type, row, meta)
                        {return row.offer.currency + " " + (data).toFixed(2)}
        },
        {"data" : "totalPrice", render: function (data, type, row, meta)
                        {return row.offer.currency + " " + (data).toFixed(2)}
        },
...
function setActiveProjectPartDetailDatatable(){
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/active_project_part_add_in_detail/o_" + id + "/";
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/service/active_project_part_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_parts?offer=' + activeProjectId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function formSubmitMessageActiveProject(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
function setNavTabSubActiveProject(){
...
/**/setActiveProjectServiceCardDetailDatatable();
    setActiveProjectServiceCardExtraDetailDatatable();
    setActiveProjectExpenseDetailDatatable();
    setActiveProjectPartDetailDatatable();
    setHTMX();
    setNavTabSubActiveProject();
    formSubmitMessageActiveProject();
