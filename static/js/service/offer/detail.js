function setOfferServiceCardDetailDatatable(){
...
/**/let apiSource = '/service/api/offer_service_cards?offer=' + offerId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function formSubmitMessageOffer(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
/**/setOfferServiceCardDetailDatatable();
    setHTMX();
    setNavTabSubOffer();
    formSubmitMessageOffer();
