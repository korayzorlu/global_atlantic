function setFinishProjectServiceCardDetailDatatable(){
    let es = elementTagSub + "-" + elementTagId;
    let id = finishProjectId
    ...
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/offer_service_card_add_in_detail/o_" + id + "/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/service/api/offer_service_cards/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/service/offer_service_card_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_service_cards?offer=' + finishProjectId + '&extra=false&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
        ...
        {"data" : "discount", render: function (data, type, row, meta)
                        {return (data).toFixed(2) + " %"}
        },
...
function setFinishProjectServiceCardExtraDetailDatatable(){
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/active_project_service_card_add_in_detail/o_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
...
/**/let deleteDataUrl = "/service/offer_service_card_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_service_cards?offer=' + finishProjectId + '&extra=true&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function setFinishProjectServiceCardExpenseDetailDatatable(){
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/active_project_expense_add_in_detail/o_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
    ...
    //Datatable Editor için editor'ü tanımlar.
    let editor = new $.fn.dataTable.Editor({
        ajax: "/service/api/offer_expenses/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/service/offer_expense_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_expenses?offer=' + finishProjectId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
        ...
        {"data" : "unitPrice", className:"editable", render: function (data, type, row, meta)
                        {return row.offer.currency.symbol + " " + (data).toFixed(2)}
        },
        {"data" : "totalPrice", render: function (data, type, row, meta)
                        {return row.offer.currency.symbol + " " + (data).toFixed(2)}
        },
        {"data" : "offer.currency.symbol"}
    ];
...
function setFinishProjectPartDetailDatatable(){
    let es = elementTagSub + "-" + elementTagId + "-part";
    let id = finishProjectId
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/service/finish_project_part_add_in_detail/o_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
    ...
    //Datatable Editor için editor'ü tanımlar.
    let editor = new $.fn.dataTable.Editor({
        ajax: "/service/api/offer_parts/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/service/offer_part_delete/";
    let serverSide = false;
/**/let apiSource = '/service/api/offer_parts?offer=' + finishProjectId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
        ...
        {"data" : "part.unit"},
        {"data" : "unitPrice", className:"editable", render: function (data, type, row, meta)
                        {return row.offer.currencySymbol + " " + (data).toFixed(2)}
        },
        {"data" : "totalPrice", render: function (data, type, row, meta)
                        {return row.offer.currencySymbol + " " + (data).toFixed(2)}
        },
...
function formSubmitMessageFinishProject(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
/**/setFinishProjectServiceCardDetailDatatable();
    setFinishProjectServiceCardExtraDetailDatatable();
    setFinishProjectServiceCardExpenseDetailDatatable();
    setFinishProjectPartDetailDatatable();
    setHTMX();
    setNavTabSubFinishProject();
    formSubmitMessageFinishProject();
