...
function setDepartmentDataTable(){/**/
    ...
    let table = $('#table-' + ef);
/**/let addDataHxGet = "/hr/department_add/";
...
/**/let deleteDataUrl = "/hr/department_delete/";
    let serverSide = true;
/**/let apiSource = '/api/departments?format=datatables';
/**/let columns = [
                    {
                        orderable: false,
                        searchable: false,
                    ...
                    {"data" : "name", className:"double-clickable" , render: function (data, type, row, meta)
                        {//return '<a hx-get="/card/company_update/' + row.id + '/" hx-target="#addUpdateDataDialogXl" style="cursor: pointer;text-decoration:underline;">' + data + '</a>';
                        return '<a hx-get="/hr/department_update/' + row.id + '/" hx-target="' + addFormBlockSubID + '" hx-swap="afterbegin" hx-push-url="true" style="cursor: pointer;text-decoration:underline;">' + data + '</a>';}
                    },          
    ...
    /**/htmx.ajax('GET', '/hr/department_update/' + data["id"] + '/', {target : addFormBlockSubID, swap : "afterbegin", "push-url" : "true"});
        window.history.pushState({}, '', '/hr/department_update/' + data["id"] + '/');
      });
