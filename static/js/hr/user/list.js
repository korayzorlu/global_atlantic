...
/**/let deleteDataUrl = "/hr/user_delete/";
    let serverSide = true;
/**/let apiSource = '/api/profiles?format=datatables';
/**/let columns = [
                    {
                        orderable: false,
                        searchable: false,
                    ...
                    {"data" : "user.last_name", className:"double-clickable", "visible": false},
                    {"data" : "user.first_name", className:"double-clickable", render: function (data, type, row, meta){
                        return '<a hx-get="/hr/user_update/' + row.pk + '/" hx-target="' + addFormBlockID + '" hx-push-url="true" style="cursor: pointer;text-decoration:underline;">' + data + ' ' + row.user.last_name + '</a>';}
                    },          
                    {"data" : "department.name", className:"double-clickable"},
                    {"data" : "position", className:"double-clickable"},
                    {"data" : "user.email", className:"double-clickable"}
    ];
    ...
    /**/htmx.ajax('GET', '/hr/user_update/' + data["pk"] + '/', {target : addFormBlockSubID, swap : "afterbegin", "push-url" : "true"});
        window.history.pushState({}, '', '/hr/user_update/' + data["pk"] + '/');
      });
