...
let _componentDatatable = function (companies_customers_api) {
  if (!$().DataTable) {
...
function addEventListeners() {
  ...
  buttonInfo.addEventListener("click", getCustomerInfo);
}

async function documentReady() {
  document.addEventListener("DOMContentLoaded", function () {
    _componentDatatable(companies_customers_api);
  });
}
