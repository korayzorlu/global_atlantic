...
function setServiceCardDataTable(){/**/
    ...
    let table = $('#table-' + ef);
/**/let addDataHxGet = "/data/service_card_add/";
...
/**/let deleteDataUrl = "/data/service_card_delete/";
    let serverSide = true;
/**/let apiSource = '/data/api/service_cards?format=datatables';
/**/let columns = [
                    {
                        orderable: false,
                        searchable: false,
                    ...
                    {"data" : "group", className:"double-clickable"},
                    {"data" : "code", className:"double-clickable", render: function (data, type, row, meta){
                        return '<a hx-get="/data/service_card_update/' + row.id + '/" hx-target="' + addFormBlockSubID + '" hx-swap="afterbegin" hx-push-url="true" style="cursor: pointer;text-decoration:underline;">' + data + '</a>';}
                    },          
                    {"data" : "name", className:"double-clickable"},
                    {"data" : "about", "width" : "40%", className:"double-clickable"}
    ];
    ...
    /**/htmx.ajax('GET', '/data/service_card_update/' + data["id"] + '/', {target : addFormBlockSubID, swap : "afterbegin", "push-url" : "true"});
        window.history.pushState({}, '', '/data/service_card_update/' + data["id"] + '/');
    });
