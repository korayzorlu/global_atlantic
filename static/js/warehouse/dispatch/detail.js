function setDispatchItemDetailDatatable(){
...
/**/let addDataHxGet = "/sale/quotation_part_update/" + elementTagId + "/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/warehouse/api/dispatch_items/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/warehouse/dispatch_item_delete/";
    let serverSide = false;
/**/let apiSource = '/warehouse/api/dispatch_items?dispatch=' + dispatchId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
...
$(document).ready(function () {
    //setDispatchItemDetailDatatable();
    //setHTMX();
