function setDispatchOrderPartDetailDatatable(){
    ...
    let table = $('#table-' + es);
/**/let addDataHxGet = "/sale/dispatch_order_part_update/" + elementTagId + "/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/sale/api/dispatch_order_parts/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/sale/dispatch_order_part_delete/";
    let serverSide = false;
/**/let apiSource = '/sale/api/dispatch_order_parts?dispatchOrder=' + dispatchOrderId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
        ...
        {"data" : "partNo", className:"text-start ps-1 pe-1", "width": "20%"},
        {"data" : "description", className:"text-start ps-1 pe-1", "width": "35%"},
        {"data" : "quantity", className:"text-end ps-1 pe-1", "width": "5%"},
        {"data" : "unit", className:"ps-1 pe-1", "width": "1%"},
        {"data" : "note", className:"editable note ps-1 pe-1", orderable: false, "width": "18%"},
        {"data" : "remark", className:"editable remark ps-1 pe-1", orderable: false, "width": "20%"}
    ];
...
function setNavTabSubDispatchOrder(){
...
$(document).ready(function () {
    setDispatchOrderPartDetailDatatable();
    //setHTMX();
    setNavTabSubDispatchOrder();
