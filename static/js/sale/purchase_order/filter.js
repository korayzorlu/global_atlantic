function setPurchaseOrderExcelDatatable(){
...
/**/let apiSource = '/sale/api/purchase_order_suppliers?format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function setPurchaseOrderExcelCustomerDatatable(){
...
/**/let deleteDataUrl = "/sale/request_part_delete/";
    let serverSide = false;
/**/let apiSource = '/sale/api/purchase_order_customers?format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function setPurchaseOrderExcelVesselDatatable(){
    let es = elementTagSub + "-vessel";
...
/**/let deleteDataUrl = "/sale/request_part_delete/";
    let serverSide = false;
/**/let apiSource = '/sale/api/purchase_order_vessels?format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
$(document).ready(function () {
    setPurchaseOrderExcelDatatable();
    setPurchaseOrderExcelCustomerDatatable();
    setPurchaseOrderExcelVesselDatatable();
});