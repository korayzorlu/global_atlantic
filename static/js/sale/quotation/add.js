...
function setNavTabSubDetailQuotationAdd(){
...
function formSubmitMessageQuotationAdd(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
        ...
        success: function (response, status, xhr) {
            ...
            if (xhr.status === 204) {
                setTimeout(function() {
                  ...
                  navTagSub.prev().children("a").addClass("active");
                  $("#tabPane-inquiry-" + elementTagId + "-add-1").addClass("show active");
...
$(document).ready(function () {
    setNavTabSubDetailQuotationAdd();
    //formSubmitMessageQuotationAdd();
