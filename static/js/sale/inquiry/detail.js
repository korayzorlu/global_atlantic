function setInquiryPartDetailDatatable(){
...
/**/let addDataHxGet = "/sale/inquiry_part_add_in_detail/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/sale/api/inquiry_parts/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/sale/inquiry_part_delete/";
    let serverSide = false;
/**/let apiSource = '/sale/api/inquiry_parts?inquiry=' + inquiryId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
...
function formSubmitMessageInquiry(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl;
...
$(document).ready(function () {
    setInquiryPartDetailDatatable();
    //setHTMXInquiry();
    setNavTabSubInquiry();
    formSubmitMessageInquiry();
