function setQuotationPartDetailONCDatatable(){
...
function setNavTabSubOrderNotConfirmation(){
...
function formSubmitMessageOrderNotConfirmation(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
$(document).ready(function () {
    setQuotationPartDetailONCDatatable();
    setHTMX();
    setNavTabSubOrderNotConfirmation();
    formSubmitMessageOrderNotConfirmation();
