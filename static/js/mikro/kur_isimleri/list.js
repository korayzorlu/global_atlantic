function setKurIsimleriDataTable(){/**/
...
/**/let deleteDataUrl = "/mikro/kur_isimleri_delete/";
    let serverSide = true;
/**/let apiSource = '/mikro/api/kur_isimleri?format=datatables';
/**/let columns = [
                      {
                        orderable: false,
                        searchable: false,
                    ...
                    // }
                    // },
                    {"data" : "kurNo", className:"double-clickable ps-1 pe-1"},
                    {"data" : "kurSembol", className:"double-clickable ps-1 pe-1"},
                    {"data" : "kurAdi", className:"double-clickable ps-1 pe-1"}
    ];
    ...
    table.DataTable({
      ...
      drawCallback: function() {
        ...
        if(api.rows().data().length == 0){
            $(tableId + ' tbody').prepend($("<tr ><td class='text-center fw-bold text-white' colspan='4' style='background-color:#9d2235;'><i class='fa-solid fa-link-slash'></i> Failed to connect to Mikro</td></tr>"));
        };
        for (var i = 0; i < api.page.len() - (rowCount === 0? 1 : rowCount); i++) {
          $(tableId + ' tbody').append($("<tr ><td>&nbsp;</td><td></td><td></td>"));
        }
      },
      "ajax" : apiSource,
      "columns" : columns
