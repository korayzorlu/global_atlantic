function setKullanicilarDataTable(){/**/
...
/**/let deleteDataUrl = "/mikro/kullanicilar_delete/";
    let serverSide = true;
/**/let apiSource = '/mikro/api/kullanicilar?format=datatables';
/**/let columns = [
                      {
                        orderable: false,
                        searchable: false,
                    ...
                    // }
                    // },
                    {"data" : "username", className:"double-clickable ps-1 pe-1"},
    ...
    table.DataTable({
      ...
      drawCallback: function() {
        ...
        for (var i = 0; i < api.page.len() - (rowCount === 0? 1 : rowCount); i++) {
          $(tableId + ' tbody').append($("<tr ><td>&nbsp;</td><td></td><td></td><td></td>"));
        }
      },
      "ajax" : apiSource,
      "columns" : columns
