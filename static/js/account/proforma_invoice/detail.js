function setProformaInvoicePartDetailDatatable(){
...
/**/let addDataHxGet = "/sale/inquiry_part_add_in_detail/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/account/api/proforma_invoice_items/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/account/proforma_invoice_part_delete/";
    let serverSide = false;
/**/let apiSource = '/account/api/proforma_invoice_items?invoice=' + proformaInvoiceId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
...
function setProformaInvoiceExpenseDetailDatatable(){
    let es = elementTagSub + "-" + elementTagId + "-expense";
    let id = proformaInvoiceId
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/account/proforma_invoice_expense_add_in_detail/i_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
    ...
    //Datatable Editor için editor'ü tanımlar.
    let editor = new $.fn.dataTable.Editor({
        ajax: "/account/api/proforma_invoice_expenses/editor/",
        table: tableId,
        idSrc: "id",
        fields: [{
            label: "quantity",
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/account/proforma_invoice_expense_delete/";
    let serverSide = false;
/**/let apiSource = '/account/api/proforma_invoice_expenses?invoice=' + proformaInvoiceId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
        ...
        {"data" : "","width": "3%"},
        {"data" : "id"},
        {"data" : "expense.code", className:"editable"},
        {"data" : "expense.name", className:"editable"},
...
function formSubmitMessageProformaInvoice(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
function setNavTabSubProformaInvoice(){
...
$(document).ready(function () {
    setProformaInvoicePartDetailDatatable();
    setProformaInvoiceExpenseDetailDatatable();
    setHTMX();
    setNavTabSubProformaInvoice();
    formSubmitMessageProformaInvoice();
});