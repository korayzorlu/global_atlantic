function setNavTabCommericalInvoice(){
    let e = elementTag;
    let ef = elementTag;
    let u = pageUrl;
    ...
    removeNav.click(function(){
        ...
        $("#createCommericalButton").removeClass("d-none");
...
function formSubmitMessageCommericalInvoiceAdd(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
        ...
        $.ajax({
            ...
            success: function (response, status, xhr) {
                ...
                if (xhr.status === 204) {
                    ...
                    setTimeout(function() {
                        $("#table-orderTracking").DataTable().ajax.reload(function() {
                            htmx.process("#table-orderTracking"); //datatable serverside'dan yükleniyorsa htmx öğelerinin çalışmasını sağlar
                        }, false);
                        $("body").busyLoad("hide", {
                        animation: "fade"
                        });
...
$(document).ready(function () {
    formSubmitMessageCommericalInvoiceAdd();
});