function setIncomingInvoicePartDetailDatatable(){
    let es = elementTagSub + "-" + elementTagId;
    let id = incomingInvoiceId
    ...
    let table = $('#table-' + es);
/**/let addDataHxGet = "/account/incoming_invoice_part_add_in_detail/i_" + id + "/";
    ...
    let editor = new $.fn.dataTable.Editor({
        ajax: "/account/api/incoming_invoice_parts/editor/",
        table: tableId,
        idSrc: "id",
        fields: [
            {
...
/**/let deleteDataUrl = "/account/incoming_invoice_part_delete/";
    let serverSide = false;
/**/let apiSource = '/account/api/incoming_invoice_parts?invoice=' + incomingInvoiceId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
...
function setIncomingInvoiceExpenseDetailDatatable(){
    ...
    let tableId = '#table-' + es;
    let table = $('#table-' + es);
/**/let addDataHxGet = "/account/incoming_invoice_expense_add_in_detail/i_" + id + "/";
    let addDataHxTarget = "#addFormBlock-inform-d-justDetail-" + es;
    ...
    //Datatable Editor için editor'ü tanımlar.
    let editor = new $.fn.dataTable.Editor({
        ajax: "/account/api/incoming_invoice_expenses/editor/",
        table: tableId,
        idSrc: "id",
        fields: [{
            label: "quantity",
    ...
    let deleteDataButton = $('.deleteData');
    let deleteDataButtonId = ".delete-" + es;
/**/let deleteDataUrl = "/account/incoming_invoice_expense_delete/";
    let serverSide = true;
/**/let apiSource = '/account/api/incoming_invoice_expenses?invoice=' + incomingInvoiceId + '&format=datatables';
/**/let columns = [
        {
            orderable: false,
            searchable: false,
...
function formSubmitMessageIncomingInvoice(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl
...
$(document).ready(function () {
    setIncomingInvoicePartDetailDatatable();
    setIncomingInvoiceExpenseDetailDatatable();
    setHTMX();
    setNavTabSubIncomingInvoice();
    //formSubmitMessageIncomingInvoice();
});