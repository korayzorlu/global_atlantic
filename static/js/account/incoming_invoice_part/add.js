function setIncomingInvoicePartAddDatatable(){
...
/**/let columns = [
        ...
        //             },
        {"data" : "maker.name", className:"editable-add"},
        {"data" : "type.type", className:"editable-add"},
        {"data" : "partNo", className:"editable-add"},
        {"data" : "group"},
        {"data" : "description"},
...
function formSubmitMessageIncomingInvoicePartAdd(){
    let ee = elementTag;
    let ei = elementTagId;
    let u = pageUrl;
    console.log(u);
    ...
    $("#form-" + ee +  "-" + ei + "-add-2").submit(function (event) {
      ...
      tableIncomingInvoiceParts = $("#table-" + elementTagSub + "-" + elementTagId);
      
      for(let i = 0; i < tableIncomingInvoiceParts.DataTable().rows({selected:true}).data().length; i++){
        formData.push({name: "incomingInvoiceParts", value: tableIncomingInvoiceParts.DataTable().rows({selected:true}).data()[i]["id"]});
      };

      //console.log(tableincomingInvoiceParts.DataTable().rows({selected:true}).data());
...
$(document).ready(function () {
    setIncomingInvoicePartAddDatatable();
    //formSubmitMessageIncomingInvoicePartAdd();
});