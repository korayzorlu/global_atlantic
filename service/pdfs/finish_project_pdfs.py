...
#####PDF#####
def finishProjectPdf(offer, sourceCompany):
    ...
    folderPath = os.path.join(os.getcwd(), "media", "docs", str(sourceCompany.id), "service", "finish_project", "documents")
...
def finishProjectPdfWithoutPrice(offer, sourceCompany):
    if sourceCompany.formalName:
        sourceCompanyFormalName = sourceCompany.formalName
    else:
        sourceCompanyFormalName = ""
